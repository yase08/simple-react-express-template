...
function DashboardHistoryPage() {
  ...
  const handleCreate = async () => {
    ...
    data.append("historyname", formData.historyname);
  ...
  const handleFetch = async () => {
    try {
      const res = await getHistorys({
        currentPage,
        search,
      });
      if (Array.isArray(res.historys)) {
        setData(res.historys);
      }
    } catch (error) {
          ...
          <div className="w-full flex flex-col">
            ...
            <dialog id="create_modal" className="modal">
              <div className="modal-box">
                <h3 className="font-bold text-lg">Create History</h3>
                <div className="grid grid-cols-2 gap-5 mb-5">
                  <label className="form-control w-full max-w-xs">
                    <div className="label">
                      <span className="label-text">Historyname</span>
                    </div>
                    <input
                      type="text"
